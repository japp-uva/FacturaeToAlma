...
class ValidationReportExporter:
    ...
    def save(self, issues):
        ...
        for issue in issues:
            ws.append([issue.issue_type, issue.invoice_number, issue.invoice_line_number, issue.isbn, issue.issn, issue.title, "; ".join(issue.candidates), issue.message])
