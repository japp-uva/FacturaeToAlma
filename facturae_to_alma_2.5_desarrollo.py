...
class FacturaeApp:
    ...
    def _build_ui(self):
        ...
        self.title_label = ttk.Label(shell, text="", font=("Segoe UI", 15, "bold"), style="App.TLabel")
    ...
    def _build_convert_tab(self):
        ...
        self.batch_tree = ttk.Treeview(self.batch_frame, columns=cols, show="headings", height=6, selectmode="extended")
    ...
    def _build_customize_tab(self):
        ...
        ttk.Label(frame, text=note, wraplength=880, justify="left", style="App.TLabel").grid(row=5, column=0, columnspan=3, sticky="w", pady=(14, 8))
    ...
    def _set_default_output(self, invoice_path, batch):
        ...
        suffix = "_lote_Alma.xlsx" if batch else "_Alma.xlsx"
        self.output_file.set(os.path.join(output_folder, base + suffix))
